               ...
               <form className='space-y-6'>
                  <div className='space-y-2'>
                     ...
                     <span className='block text-xs text-muted-foreground italic'>
                        This option will be avalieble soon
                     </span>
                  </div>
                  ...
                  <div className="space-y-2">
                     ...
                     />
                     <span
                        className="block text-xs text-muted-foreground italic lea">
                        The higher the value the most creative the text will get and more prone to errors as well.
                     </span>
                  </div>
               </form>
            </aside>
